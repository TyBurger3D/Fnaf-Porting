...
default_mappings = MappingCollection(
    textures=[
        ...
        SlotMapping("BC", "Diffuse"),
        SlotMapping("_BC", "Diffuse"),
        ...
        SlotMapping("_ORM", "SpecularMasks"),
        SlotMapping("HRM/ORM Map", "SpecularMasks"),
        ...
        SlotMapping("E", "Emission"),
        SlotMapping("_E", "Emission"),
        SlotMapping("InterEmiss - CellMask", "Emission"),
        SlotMapping("EmissiveTexture", "Emission"),
        SlotMapping("Emmissive Map ...", "Emission"),
        SlotMapping("Emmissive Map", "Emission"),
