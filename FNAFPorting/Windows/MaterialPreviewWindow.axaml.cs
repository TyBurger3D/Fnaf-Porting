...
using FNAFPorting.Models.Nodes;
using FNAFPorting.Models.Nodes.Material;
using FNAFPorting.WindowModels;

namespace FNAFPorting.Windows;

public partial class MaterialPreviewWindow : WindowBase<MaterialPreviewWindowModel>, IPreviewWindow
{
