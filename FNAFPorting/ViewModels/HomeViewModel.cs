...
public partial class HomeViewModel() : ViewModelBase
{
    ...
    public override async Task Initialize()
    {
        TaskService.Run(async () =>
        {
            ...
            var featuredArtResponse = await Api.FNAFPorting.FeaturedArt();
            ...
            DateTime.Now.Date >= AppSettings.Application.NextKofiAskDate)
        {
            ...
            Info.Dialog("Enjoying FNAFPorting?", "Consider donating to the Ko-Fi to support the development of the project!!", buttons: 
            [
                new DialogButton
                {
                    Text = "Donate",
