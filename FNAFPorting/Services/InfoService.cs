...
using Information_MessageData = FNAFPorting.Models.Information.MessageData;
using MessageData = FNAFPorting.Models.Information.MessageData;
using Models_Information_MessageData = FNAFPorting.Models.Information.MessageData;

namespace FNAFPorting.Services;

public partial class InfoService : ObservableObject, IService, ILogEventSink
{
    [ObservableProperty] private ObservableCollection<Models_Information_MessageData> _messages = [];
    ...
    {
        Message(new Models_Information_MessageData(title, message, severity, autoClose, id, closeTime, useButton, buttonTitle, buttonCommand, useProgress, progressCurrent, progressTotal));
    }

    public void Message(Models_Information_MessageData data)
    {
    ...
    public void HandleException(Exception e)
    {
        ...
        {
            TaskService.Run(async () => await Api.FNAFPorting.PostError(e));
        }
#endif
