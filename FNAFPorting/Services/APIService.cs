...
{
    public readonly FNAFPortingAPI FNAFPorting;
    public readonly RepositoryAPI Repository;
    ...
    public APIService()
    {
        ...
        {
            UserAgent = $"FNAFPorting/{Globals.VersionString}",
        ...
        FNAFPorting = new FNAFPortingAPI(fpClient);
        Repository = new RepositoryAPI(_client);
