...
using BaseAssetItem = FNAFPorting.Models.Assets.Base.BaseAssetItem;
...
public partial class AssetsView : ViewBase<AssetsViewModel>
{
    ...
    private void OnSelectionChanged(object? sender, SelectionChangedEventArgs e)
    {
        ...
        foreach (var asset in listBox.SelectedItems.Cast<BaseAssetItem>())
        {
            ...
            {
                if (assetItem.AssetInfo is not null)
                {
                    ViewModel.AssetLoader.ActiveLoader.SelectedAssetInfos.Add(assetItem.AssetInfo);
                    continue;
                }
