...
namespace FNAFPorting.Models.Plugin;
...
public partial class UnrealInstallation : ObservableObject
{
    ...
    public Bitmap Image { get; private set; } =
        ImageExtensions.AvaresBitmap("avares://FNAFPorting/Assets/UnrealLogo.png");
    ...
    [JsonIgnore]
    public string FNAFPortingFolder => Path.Combine(PluginsFolder, "FNAFPorting");
    
    [JsonIgnore]
    public string UEFormatFolder => Path.Combine(PluginsFolder, "UEFormat");

    [JsonIgnore]
    public string MetaPath => Path.Combine(FNAFPortingFolder, "fnaf_porting_meta.json");
    ...
    public void Uninstall()
    {
        ...
        if (Directory.Exists(FNAFPortingFolder))
            Directory.Delete(FNAFPortingFolder, true);
