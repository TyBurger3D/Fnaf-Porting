...
public partial class BlenderInstallation(string blenderExecutablePath) : ObservableObject
{
    ...
    public void Install(bool verbose = true)
    {
        ...
        MiscExtensions.Copy(Path.Combine(PluginWorkingDirectory.FullName, "fnaf_porting"), Path.Combine(StartupPath, "fnaf_porting"));
    ...
    public void Uninstall()
    {
        ...
        if (IsValidInstallation)
            Directory.Delete(Path.Combine(StartupPath, "fnaf_porting"), true);
    }
