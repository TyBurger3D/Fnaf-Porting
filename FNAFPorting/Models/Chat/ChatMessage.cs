...
public partial class ChatMessage : ObservableObject, IChatFeedItem
{
    ...
    private static readonly Bitmap ReactOn = ImageExtensions.AvaresBitmap("avares://FNAFPorting/Assets/YeahOff.png");
    private static readonly Bitmap ReactOff = ImageExtensions.AvaresBitmap("avares://FNAFPorting/Assets/YeahOn.png");

    [RelayCommand]
    public async Task React()
    {
        await Api.FNAFPorting.ReactToMessage(Id);
    }
