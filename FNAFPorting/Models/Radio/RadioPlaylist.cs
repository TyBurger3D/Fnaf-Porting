...
namespace FNAFPorting.Models.Radio;
...
public partial class RadioPlaylist : ObservableObject
{
    ...
    {
        IsDefault = isDefault;
        PlaylistCover = ImageExtensions.AvaresBitmap("avares://FNAFPorting/Assets/FN/DefaultPlaylistImage.png");
    ...
    public static async Task<RadioPlaylist> FromSerializeData(RadioPlaylistSerializeData serializeData)
    {
        ...
        {
            playlist.PlaylistCover = ImageExtensions.AvaresBitmap("avares://FNAFPorting/Assets/FN/DefaultPlaylistImage.png");
        }
