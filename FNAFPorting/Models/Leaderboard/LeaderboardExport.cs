...
public partial class LeaderboardExport : ObservableObject
{
    ...
    public async Task<bool> Load()
    {
        ...
        {
            ObjectName = ID;
            ExportBitmap = asset.GetEditorIconBitmap() ?? ImageExtensions.AvaresBitmap("avares://FNAFPorting/Assets/Unreal/DataAsset_64x.png");
            return true;
        }
        ...
        else
        {
            ...
            ExportBitmap = icon?.Decode()?.ToWriteableBitmap() ?? asset.GetEditorIconBitmap() ?? ImageExtensions.AvaresBitmap("avares://FNAFPorting/Assets/Unreal/DataAsset_64x.png");
            CachedBitmaps[ObjectPath] = ExportBitmap;
        }
    ...
    {
        ExportBitmap = ImageExtensions.AvaresBitmap("avares://FNAFPorting/Assets/Unreal/DataAsset_64x.png");
        ObjectName = ID;
    }
}