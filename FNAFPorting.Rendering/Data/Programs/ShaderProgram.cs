...
namespace FNAFPorting.Rendering.Data.Programs;
...
public class ShaderProgram : Program
{
    ...
    private int CompileShader(string name, ShaderType type)
    {
        ...
        var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"FNAFPorting.Rendering.Shaders.{name}.{ext}")!;
